...
flat_L_prompt_modified_gravity = """
**System Information**
...
place("screw", "orange", 3, 1, 1)
place("screw", "orange", 3, 2, 1)
place("screw", "orange", 3, 3, 1)
place("screw", "orange", 3, 4, 1)
place("screw", "orange", 3, 5, 1)
place("screw", "orange", 4, 5, 1)
place("screw", "orange", 5, 5, 1)
place("screw", "orange", 6, 5, 1)
place("screw", "orange", 7, 5, 1)
place("screw", "orange", 8, 5, 1)
...
place("screw", "green", 3, 1, 1)
place("screw", "green", 3, 2, 1)
place("screw", "green", 3, 3, 1)
place("screw", "green", 3, 4, 1)
place("screw", "green", 3, 5, 1)
place("screw", "green", 3, 6, 1)
place("screw", "green", 4, 6, 1)
place("screw", "green", 5, 6, 1)
place("screw", "green", 6, 6, 1)
place("screw", "green", 7, 6, 1)
place("screw", "green", 8, 6, 1)
...
place("washer", "blue", 3, 7, 1)
place("washer", "blue", 4, 7, 1)
place("washer", "blue", 5, 7, 1)
place("washer", "blue", 6, 7, 1)
place("washer", "blue", 7, 7, 1)
place("washer", "blue", 8, 7, 1)
place("washer", "blue", 9, 7, 1)
...
def pred_op(input_instruction):
    messages = [
        {
            'role':'system',
            'content':flat_L_prompt_modified_gravity
        },
        {
            'role':'user',
...
if __name__ == "__main__":
    get_llama_output("flat_L_data.json","flat_L_pred.json")