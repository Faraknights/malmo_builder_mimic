				...
				b = function (e) {
					if (e.cancelable) {
						var t,
							n,
							i,
							r = (e.timeStamp > 1e12 ? new Date() : performance.now()) - e.timeStamp;
						'pointerdown' == e.type
							? ((t = function () {
									L(r, e), i();
								}),
								...
								(i = function () {
									removeEventListener('pointerup', t, E), removeEventListener('pointercancel', n, E);
								}),
